#ifndef CAFFE_SIGMOID_CROSS_ENTROPY_WEIGHT_LOSS_LAYER_HPP_
#define CAFFE_SIGMOID_CROSS_ENTROPY_WEIGHT_LOSS_LAYER_HPP_
...
class SigmoidCrossEntropyWeightLossLayer : public LossLayer<Dtype> {
 public:
  explicit SigmoidCrossEntropyWeightLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "SigmoidCrossEntropyWeightLoss"; }

 protected:
  /// @copydoc SigmoidCrossEntropyWeightLossLayer
